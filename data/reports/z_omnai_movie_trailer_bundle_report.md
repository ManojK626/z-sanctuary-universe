...
| Public release | not_approved |
| Rights posture | original_or_permission_required |
...
- **story_concept:** 4 prompt(s)
- **world_bible:** 3 prompt(s)
- **character_roles:** 3 prompt(s)
- **trailer_structure:** 3 prompt(s)
- **scene_beats:** 2 prompt(s)
- **shot_list:** 2 prompt(s)
- **visual_style_guide:** 3 prompt(s)
- **music_sound_brief:** 3 prompt(s)
- **poster_key_art_brief:** 3 prompt(s)
- **accessibility_and_sensory_notes:** 3 prompt(s)
- **safety_rights_checklist:** 2 prompt(s)
- **review_questions_for_amk:** 4 prompt(s)
...
- original_or_permission_required
...
- Does this trailer honestly represent the feature?
- Are all superlatives evidenced or removed?
- Are minors or sensitive populations treated per policy?
- Is any pricing, donation, or commercial CTA attached? If yes, route Z-SUSBV and entitlement review.
- AMK decision: approve internal pack only — [date]
- AMK decision: open public screener lane — [blocked until gate]
