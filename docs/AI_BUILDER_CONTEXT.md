...
8. [Z_POWERSHELL_OPERATOR_BOOST.md](Z_POWERSHELL_OPERATOR_BOOST.md) — **Z-PS-BOOST-1:** governed PowerShell operator boost for hub-root commands, dry-run doorway use, receipts, and approval-safe shell rhythm.
