...
8. [Z_POWERSHELL_OPERATOR_BOOST.md](Z_POWERSHELL_OPERATOR_BOOST.md) — **Z-POWERSHELL-BOOST-1:** local-first PowerShell operator guidance for command hygiene and verification posture; not automation, deploy, merge, secret, or cloud authority.
