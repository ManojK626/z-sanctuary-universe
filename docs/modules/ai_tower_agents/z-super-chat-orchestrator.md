...
| **Safety class** | low |
| **Z registry ZID** | z-super-chat-orchestrator |
| **Zuno audit status** | FOUND_FULL |

## Purpose

Local-first voice+text orchestrator across registered projects with citations, policy gate, approval actions, and evidence spine.

## Current Evidence

- `docs/Z-SUPER-CHAT-BLUEPRINT.md` — **present**
