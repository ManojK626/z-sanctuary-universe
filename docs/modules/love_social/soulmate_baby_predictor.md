# Soulmate / baby prediction (concept)
...
Doctrine only. Requires consent boundary doc before any data collection or UX.
...
- Add doc_mentions in master for docs/safety/BABY_PREDICTOR_CONSENT_BOUNDARY.md with tokens present in those files, then npm run zuno:coverage.
