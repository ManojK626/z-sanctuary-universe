# Z-SPI decision advisor (Phase 2)

## Registry Identity

| Field | Value |
| --- | --- |
| **ID** | `z-spi-decision-advisor` |
| **Category** | trust_audit_governance |
| **Registry status** | implemented |
| **Safety class** | low |
| **Z registry ZID** | z-spi-decision-advisor |
| **Zuno audit status** | FOUND_FULL |

## Purpose

Advisory merge of SPI decision_suggestions with pending governance rows → z_spi_decision_advice.{json,md}. Dashboard panel dashboard/panels/z_decision_panel.html.

## Current Evidence

- `scripts/z_spi_decision_advisor.mjs` — **present**
