# Z-QOSMEI core signal fusion (Phase 1)

## Registry Identity

| Field | Value |
| --------------------- | ----------------------------- |
| **ID** | `z-qosmei-core-signal-fusion` |
| **Category** | trust_audit_governance |
| **Registry status** | implemented |
| **Safety class** | low |
| **Z registry ZID** | z-qosmei-core-signal-fusion |
| **Zuno audit status** | FOUND_FULL |

## Purpose

Advisory fusion vector from guardian/alerts/decisions/patterns/rootcause/predict/adaptive/execution. Emits z_qosmei_core_signal.{json,md} for dashboard rail, AI status, Whale Bus, and Zuno.

## Current Evidence

- `scripts/z_qosmei_signal_fusion.mjs` — **present**
