...
| Field | Value |
| --- | --- |
| **ID** | `z-structural-pattern-intelligence` |
| **Category** | trust_audit_governance |
| **Registry status** | implemented |
| **Safety class** | low |
| **Z registry ZID** | z-structural-pattern-intelligence |
| **Zuno audit status** | FOUND_FULL |

## Purpose

Cross-layer advisory (v2): predictive_signals, evolution_phase, decision_suggestions, pre_warnings file for Guardian. Emits z_structural_patterns.{json,md} + z_spi_guardian_pre_warnings.json.

## Current Evidence

- `scripts/z_structural_pattern_intelligence.mjs` — **present**
