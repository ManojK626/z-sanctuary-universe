...
- Add doc_mentions in master for docs/safety/GAMBLING_PREDICTION_BOUNDARY.md, docs/safety/LOTTERY_RESPONSIBLE_USE_BOUNDARY.md with tokens present in those files, then npm run zuno:coverage.
