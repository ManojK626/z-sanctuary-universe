...
| Field | Value |
| --- | --- |
| **ID** | `roulette-calculator` |
| **Category** | gaming_compliance |
| **Registry status** | safety_hold |
| **Safety class** | high |
| **Z registry ZID** | roulette-calculator |
| **Zuno audit status** | NEEDS_SAFETY_REVIEW |

## Purpose

Legacy Roulette Calculator workspace imported and linked to Z-Modules Registry.
...
- Add doc_mentions in master for docs/safety/GAMBLING_PREDICTION_BOUNDARY.md with tokens present in those files, then npm run zuno:coverage.
