...
- vile/SHADOW_VALIDATION_PIPELINE.md (`../vile/SHADOW_VALIDATION_PIPELINE.md`; STATUS: REFERENCED_BUT_MISSING)  
- Z_SANCTUARY_OPERATIONAL_POSTURE_2026.md (`../Z_SANCTUARY_OPERATIONAL_POSTURE_2026.md`; STATUS: REFERENCED_BUT_MISSING)  
