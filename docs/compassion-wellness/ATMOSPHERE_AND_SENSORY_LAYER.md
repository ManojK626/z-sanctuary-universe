...
**Phase:** 0 — Sensory design doctrine (no playback runtime)

**Scope:** Comfort, relaxation, and atmosphere support only — **no health claims** beyond that.
...
Before applying a preset, surface:

- Asthma / respiratory sensitivity
- Migraine / light sensitivity
- Pet species in room (cat, dog, bird, small mammal)
- Pregnancy (gentle defaults, no strong essential oil blast)
- Elder fragility (trip hazards with real candles)
...
Allowed language: «supports relaxation and comfort atmosphere.»
Forbidden: cure, detox, miracle healing, or replacement for clinical treatment.

---

## Cross-links

- [TOOLS_EQUIPMENT_AND_PLANT_SUPPORT_POLICY.md](TOOLS_EQUIPMENT_AND_PLANT_SUPPORT_POLICY.md)
