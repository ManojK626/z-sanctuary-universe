# Compassion Wellness Charter

**Authority:** Ethical foundation for the Compassion Wellness & Lifeform Care Ecosystem
...
Help **life care for life** — humans, elders, disabled users, families, practitioners, caregivers, rescuers, and animals — with **dignity**, **consent**, and **practical** support. Grounded, inclusive, and **non-cultic**.

---

## Core principles

1. **Human dignity** — Every person deserves respect, clear communication, and the right to stop or change a session.
2. **Animal dignity** — Companion animals are sentient beings; care paths must reduce harm, not commodify life.
3. **Elder protection** — Extra safeguards for cognitive vulnerability, isolation, and continuity of care.
4. **Practitioner protection** — Fair process, accurate records, and protection from false accusations without secret punishment.
5. **User consent** — No data collection or service extension without informed, revocable consent.
6. **Privacy ownership** — Users own their wellness and care narratives; the platform is a steward, not an owner.
7. **Human-in-the-loop governance** — Sensitive decisions require human review; AI organizes, humans decide.
...
- Aligns with [Z_SWARM_14DRP_UNIVERSAL_AGENT_LAW.md](../Z_SWARM_14DRP_UNIVERSAL_AGENT_LAW.md) — compassion anchor, not automated moral oracle.
- **AMK-Goku / human** remains authority for merge, deploy, sensitive policy changes, and sacred gates per hub doctrine.
- Phase advances only per [TURTLE_MODE_ROADMAP.md](TURTLE_MODE_ROADMAP.md).

---

## Rollback

Remove or archive `docs/compassion-wellness/` and revert INDEX / AI_BUILDER pointers if the pack is withdrawn.
