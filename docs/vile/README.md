...
| [TRACK_A_VILE_FOUNDATION_INTEGRATION.md](TRACK_A_VILE_FOUNDATION_INTEGRATION.md)       | Track A P0 mission checklist                             |
| [Z_VILE_FOUNDATION_READINESS_OVERSEER.md](Z_VILE_FOUNDATION_READINESS_OVERSEER.md)     | Readiness rollup · `npm run z:vile:foundation:readiness` |
